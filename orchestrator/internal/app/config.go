...
func loadOrchestratorConfig() orchestratorConfig {
	return orchestratorConfig{
		...
		PaymentAddr:            envx.StringDefault("GPT_PAYMENT_ADDR", "127.0.0.1:50054"),
		...
		CodexOAuthPhoneLabel:                    envx.StringDefault("CODEX_OAUTH_PHONE_LABEL", contracts.WorkflowLabelForAction(contracts.ActionCodexOAuthAddPhone)),
