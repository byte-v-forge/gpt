...
type CodexOAuthLoginBrowserInput = pb.CodexOAuthLoginBrowserInput
type CodexOAuthLoginBrowserOutput = pb.CodexOAuthLoginBrowserOutput
...
type GoPayAppOTPWorkflowInput = pb.GoPayAppOTPWorkflowInput
type GoPayAppChangePhoneWorkflowInput = pb.GoPayAppChangePhoneWorkflowInput
type GoPayAppDeactivateWorkflowInput = pb.GoPayAppDeactivateWorkflowInput
...
type CodexOAuthWorkflowInput = pb.CodexOAuthWorkflowInput
type CodexOAuthWorkflowResult = pb.CodexOAuthWorkflowResult
type CodexOAuthAddPhoneWorkflowInput = pb.CodexOAuthAddPhoneWorkflowInput
type CodexOAuthAddPhoneWorkflowResult = pb.CodexOAuthAddPhoneWorkflowResult
type CodexOAuthBatchAddPhoneWorkflowInput = pb.CodexOAuthBatchAddPhoneWorkflowInput
type CodexOAuthBatchAddPhoneWorkflowResult = pb.CodexOAuthBatchAddPhoneWorkflowResult
