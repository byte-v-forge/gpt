...
export type GptAccountsViewProps = {
  ...
  onProbeAccount: (account: Account) => void | Promise<void>;
  onRegisterActivate: (account: Account) => void | Promise<void>;
    ...
    <section className="workspace singlePaneWorkspace">
      <div className="panel">
        ...
        <AccountTable
          ...
          onProbeAccount={props.onProbeAccount}
          onRegisterActivate={props.onRegisterActivate}
